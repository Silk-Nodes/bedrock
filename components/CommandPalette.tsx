...
const DESTS: Dest[] = [
  ...
  { label: "Signals · Big movers", href: "/signals/whales", group: "Signals", keywords: "big movers large moves whales notable deposits biggest transfers delegations chain-wide" },
  { label: "Rich List", href: "/rich-list", group: "Rich List", keywords: "rich list whale board top 100 holders track addresses claimed delegated undelegated exchange flows profile watch" },
  { label: "Rich List · Activity", href: "/rich-list/activity", group: "Rich List", keywords: "whale activity feed alerts significant moves exchange deposits large delegations reward claims" },
